...
function freeze(G) {
  function frozen() {
    ...
    _JSNetworkXError[
    /*istanbul ignore next*/
    "default"]("Frozen graph can't be modified");
...
function createEmptyCopy(G) {
  /*istanbul ignore next*/
  var optWithNodes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
function info(G, optN) {
  ...
  if (optN == null) {
    ...
    _internals.
    /*istanbul ignore next*/
    sprintf)(template, G.name, G.constructor.__name__, nnodes, G.numberOfEdges());
    ...
    if (nnodes > 0) {
      if (G.isDirected()) {
        ...
        try {
          for (
          /*istanbul ignore next*/
          var _iterator = G.inDegree().values()[Symbol.iterator](), _step;
          /*istanbul ignore next*/
        ...
        try {
          for (
          /*istanbul ignore next*/
          var _iterator2 = G.outDegree().values()[Symbol.iterator](), _step2;
          /*istanbul ignore next*/
        ...
        try {
          for (
          /*istanbul ignore next*/
          var _iterator3 = G.degree().values()[Symbol.iterator](), _step3;
          /*istanbul ignore next*/
        ...
        _internals.
        /*istanbul ignore next*/
        sprintf)('Average degree: %s', (sum / nnodes).toFixed(4));
      }
    }
  } else {
    if (!G.hasNode(optN)) {
