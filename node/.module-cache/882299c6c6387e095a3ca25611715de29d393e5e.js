...
exports.randomGraphs = void 0;

var
/*istanbul ignore next*/
_randomGraphs = require("../randomGraphs");
...
var randomGraphs = {
  ...
  testGnp() {
    ...
    for (
    /*istanbul ignore next*/
    var _i = 0, _generators = generators;
    /*istanbul ignore next*/
    _i < _generators.length;
    /*istanbul ignore next*/
    _i++) {
      var generator =
      /*istanbul ignore next*/
      ...
      assert(G.isDirected());
      assert.equal(G.numberOfNodes(), 10);
      assert.equal(G.numberOfEdges(), 90); // assert that random graphs generate all edges for p close to 1
