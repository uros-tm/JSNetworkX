    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            addPrefix = function _ref2(graph, prefix) {
              if (!prefix) {
                return graph;
              }
...
function _disjointUnion() {
  _disjointUnion = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function
  /*istanbul ignore next*/
  _callee2(G, H)
...
function _intersection() {
  _intersection = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function
  /*istanbul ignore next*/
  _callee3(G, H)
...
function _symmetricDifference() {
  _symmetricDifference = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function
  /*istanbul ignore next*/
  _callee5(G, H)
