...
function observe(G) {
  ...
  G.addNodesFrom = function (nbunch) {
    ...
    try {
      for (
      /*istanbul ignore next*/
      var _iterator = nbunch[Symbol.iterator](), _step;
      /*istanbul ignore next*/
  ...
  G.addEdgesFrom = function (ebunch) {
    ...
    try {
      for (
      /*istanbul ignore next*/
      var _iterator2 = ebunch[Symbol.iterator](), _step2;
      /*istanbul ignore next*/
  ...
  G.removeNodesFrom = function (nbunch) {
    ...
    try {
      for (
      /*istanbul ignore next*/
      var _iterator3 = nbunch[Symbol.iterator](), _step3;
      /*istanbul ignore next*/
  ...
  G.removeEdgesFrom = function (ebunch) {
    ...
    try {
      for (
      /*istanbul ignore next*/
      var _iterator4 = ebunch[Symbol.iterator](), _step4;
      /*istanbul ignore next*/
